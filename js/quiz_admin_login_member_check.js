...
function fetchLoginMembersOnAjax() {
    ...
    xhrLogin.send(encodeHtmlForm({'fnc_name':'fetchQuizLoginMembers', 'login_state': '2'}));
}
...
function fetchNotLoginMembersOnAjax() {
    ...
    xhrNotLogin.send(encodeHtmlForm({'fnc_name':'fetchQuizNotLoginMembers', 'login_state':'2'}));
}
